...
if (!function_exists('seo')) {
    function seo() {
        return \App\Helper\Seo::instance();
    }
}

if (!function_exists('storage_url')) {
    function storage_url($path, $size = null) {
        $path = str_replace('%s', $size, $path);
        return \Illuminate\Support\Facades\Storage::disk('public')->url($path);
    }
}

if (!function_exists('country_lists')) {
    function country_lists() {
        $countries = [
            ...
            ['title' => 'Heard Island and McDonald Mcdonald Islands', 'value' => 'HM'],
...
if (!function_exists('timezone_lists')) {
...
if (!function_exists('format_currency')) {
    function format_currency($amount) {
        return $amount.' '.config('default-currency', 'USD');
    }
}
